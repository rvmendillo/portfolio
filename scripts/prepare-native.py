...
for name in ['Qwen-LICENSE.txt','llama.cpp-LICENSE.txt']:shutil.copyfile(ROOT/'assets/licenses'/name,models/name)
shutil.copyfile(ROOT/'shared/model.json',models/'model.json')
shutil.copyfile(ROOT/'THIRD_PARTY.md',models/'THIRD_PARTY.md')
